...
/** 
 * DAO for table "TEST_GREEN_DAO".
*/
public class TestGreenDaoDao extends AbstractDao<ChannelNewsBean, Long> {

    public static final String TABLENAME = "TEST_GREEN_DAO";
    ...
    */
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"TEST_GREEN_DAO\" (" + //
    ...
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"TEST_GREEN_DAO\"";
        db.execSQL(sql);
    }
