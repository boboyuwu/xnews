...
/** 
 * DAO for table "CHANNEL_NEWS_DATA".
*/
public class ChannelNewsDataDao extends AbstractDao<ChannelNewsData, Long> {

    public static final String TABLENAME = "CHANNEL_NEWS_DATA";
    ...
    */
    ...
    public ChannelNewsDataDao(DaoConfig config) {
        super(config);
    }
    
    public ChannelNewsDataDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"CHANNEL_NEWS_DATA\" (" + //
    ...
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"CHANNEL_NEWS_DATA\"";
        db.execSQL(sql);
    }
