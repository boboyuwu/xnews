...
/**
 * Created by wubo on 2015/11/9.
 *
 * 分页展示数据时，RecyclerView的FooterView StateEnum 操作工具类
 *
...
public class RecyclerViewStateUtils {
    ...
    /**
     * 设置headerAndFooterAdapter的FooterView StateEnum
     *
     * @param instance      context
     * @param recyclerView  recyclerView
     * @param pageSize      分页展示时，recyclerView每一页的数量
     * @param state         FooterView StateEnum
     * @param errorListener FooterView处于Error状态时的点击事件
     */
    public static void setFooterViewState(Activity instance, RecyclerView recyclerView, int pageSize, State state, View.OnClickListener errorListener) {
        ...
        if (headerAndFooterAdapter.getFooterViewsCount() > 0) {
            ...
            if (state.getStateEnum() == StateEnum.NetWorkError) {
     ...
     * @param recyclerView
     */
    public static StateEnum getFooterViewState(RecyclerView recyclerView) {
