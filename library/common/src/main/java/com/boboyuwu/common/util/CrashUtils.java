...
public final class CrashUtils {
    ...
    static {
        try {
            PackageInfo pi = ActivityUtils.getApp().getPackageManager().getPackageInfo(ActivityUtils.getApp().getPackageName(), 0);
            if (pi != null) {
    ...
    public static boolean init(final String crashDir) {
        ...
        if (Environment.MEDIA_MOUNTED.equals(Environment.getExternalStorageState())
                && ActivityUtils.getApp().getExternalCacheDir() != null)
            defaultDir = ActivityUtils.getApp().getExternalCacheDir() + FILE_SEP + "crash" + FILE_SEP;
        else {
            defaultDir = ActivityUtils.getApp().getCacheDir() + FILE_SEP + "crash" + FILE_SEP;
        }
