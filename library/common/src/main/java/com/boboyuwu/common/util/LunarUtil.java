...
public class LunarUtil {
	 ...
	 * 国历节日 *表示放假日
	 */
	private final static String[] sFtv = { "0101*元旦","0404*清明节","0501*劳动节","1001*国庆节", "1225 圣诞节",};
	
/*	private final static String[] sFtv = { "0101*元旦", "0115 元宵节", "0214 情人节",
		"0308 妇女节", "0312 植树节", "0315 315", "0401 愚人节", "0501*劳动节",
		"0504 青年节", "0509 郝维节", "0512 护士节", "0601 儿童节",
		"0701 香港回归", "0801 建军节",
		"0816 燕衔泥节", "0909 毛泽东逝世", "0910 教师节",
		"0928 孔子诞辰", "1001*国庆节", "1006 老人节", "1024 联合国日", "1111 光棍节",
		"1112 孙中山诞辰", "1220 澳门回归", "1225 圣诞节",
		"1226 毛泽东诞辰" };*/
	/**
	 * 农历节日 *表示放假日
	 */
